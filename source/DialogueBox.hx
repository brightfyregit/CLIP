...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'paperclips' || PlayState.SONG.song.toLowerCase() == 'ray' || PlayState.SONG.song.toLowerCase() == 'bonk' || PlayState.SONG.song.toLowerCase() == 'limbs' || PlayState.SONG.song.toLowerCase() == 'nutella' || PlayState.SONG.song.toLowerCase() == 'are-you-nuts')
		{
			...
			portraitLeftc = new FlxSprite(-700, 25).loadGraphic(Paths.image('hazelface', 'shared'));
			portraitLeftc.setGraphicSize(Std.int(portraitLeftc.width * PlayState.daPixelZoom * 0.12));
			portraitLeftc.updateHitbox();
			portraitLeftc.setGraphicSize(Std.int(portraitLeftc.width * 1.5));
			portraitLeftc.scrollFactor.set();
			portraitLefta.visible = false;
			portraitLeftb.visible = false;
			portraitLeftc.visible = false;
			if (PlayState.SONG.song.toLowerCase() == 'limbs' || PlayState.SONG.song.toLowerCase() == 'nutella' || PlayState.SONG.song.toLowerCase() == 'are-you-nuts')
			{
				add(portraitLefta);
				add(portraitLeftb);
				add(portraitLeftc);
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == 'paperclips' || PlayState.SONG.song.toLowerCase() == 'ray' || PlayState.SONG.song.toLowerCase() == 'bonk' || PlayState.SONG.song.toLowerCase() == 'limbs' || PlayState.SONG.song.toLowerCase() == 'nutella' || PlayState.SONG.song.toLowerCase() == 'are-you-nuts')
		{
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if ((PlayState.SONG.song.toLowerCase() == 'paperclips' || PlayState.SONG.song.toLowerCase() == 'ray' || PlayState.SONG.song.toLowerCase() == 'bonk' || PlayState.SONG.song.toLowerCase() == 'limbs') || PlayState.SONG.song.toLowerCase() == 'nutella' || PlayState.SONG.song.toLowerCase() == 'are-you-nuts' && !cut)
	...
	function leftPortraitCSet():Void
	{
		if (PlayState.SONG.song.toLowerCase()=='nutella' || PlayState.SONG.song.toLowerCase() == 'are-you-nuts')
		{
			swagDialogue.sounds = [FlxG.sound.load(Paths.sound('clipTalk'), 0.6)];
		}
		else
